...
\begin{figure}[!htb]
\centering
\includegraphics[width=.5\textwidth]{buffon-pi=317.pdf}
...
Before an in depth description of the \gls{mcrt} method is outlined, we must discuss optical properties of materials, which the \gls{mcrt} method needs to use in order to simulate the transport of phtons in a material.
...
\centering
\includegraphics[width=.5\textwidth]{algopic.pdf}
\caption{Flowchart of the \gls{mcrt} algorithm as described in this section.}
\label{fig:algo}
\vspace{-80pt}
\end{wrapfigure}
\leavevmode
...
This section details the actual implementation of the \gls{mcrt} algorithm detailed in the previous section, along with any computational necessities and speed ups on the original algorithm.
