...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=.3]{grid-decomp.pdf}
...
The theoretical models behind explosive and thermal ablation models are also not well understood, with many models proposed to try to and explain experimental results. These models range from heuristic models to sophisticated models that relate the underlying physical mechanisms to ablation damage. 
...
\begin{figure}
	\centering
    \includegraphics[width=.85\textwidth]{70w-circular.pdf}
...
\end{figure}
 ...
 \begin{figure}
	\centering
    \includegraphics[width=.85\textwidth]{70w-gaussian.pdf}
...
The ablation crater depth can be seen by the evidence of the ``dark valley'' before the jump in temperature.
The border of the crater region is slightly cooler, with a maximum slightly deeper into the tissue.
This temperature maximum extends for a small distance into the tissue, before diffusion spreads it out.


\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.85\textwidth]{temp-profile-middle.pdf}
...
Once the laser reaches maximum power
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=.85\textwidth]{damage-slice.pdf}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.7]{70w-400.pdf}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.7]{70w-50.pdf}
...
In the 1964 James Bond film, Goldfinger, James Bond is threatened with a laser by the titular antagonist ()\cref{fig:goldfinger}.
...
The model can also be applied to help optimise laser assisted drug delivery. Laser assisted drug delivery consists of using a laser to ``drill'' holes into the skin to help topical medicines diffuse into the skin better, than just applying the medicines to skin with no holes. Our model can help predict the laser parameters needed to reach a certain hole depth, thus minimising thermal damage and pain to patients.
