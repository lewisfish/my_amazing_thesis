...
If the packet is refracted, and moved into a new direction to the planar surface of the lens.
...
\Gls*{hobb} have found a use for optical trapping targets that are reflective/low refractive index, and optical manipulation~\cite{garces2002transfer,garces2003observation}.
...
This allows a better comparison between the Gaussian beams' core and the Bessel beam's core and gives a more comparable intensity between the beams at the location of the Gaussian beams focus.
