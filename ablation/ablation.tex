...
To model all these tissue damage processes the tissue damage model is split into two sections: coagulation damage and ``physical'' damage. ``Physical'' damage changes the tissue optical and thermal properties.
