...
\lipsum[1-2]
% First of all, thank you too Tom, and Kenny for first allowing me the oppertunity to undertake this PhD and for all their support and encouragement over the course of my thesis.
% If it weren't for them keeping me on the straight and narrow I'm sure I would still be coding instead of writing.
% I swar I've fixed all the bugs now...
...
\bibliography{./introduction/intro,./ablation/ablation,./MCRT/mcrt,./bessel/bessel,./fluro/salvo}
