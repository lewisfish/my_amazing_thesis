...
\begin{figure}
	...
	\caption{Spectra of some of the more common absorbers found in the skin.***refs***}
	\label{fig:absorb}
\end{figure}
...
There are various other optical parameters that can define a medium. These other parameters generally are used to model microphysics such as Raman scattering, polarization, or fluorescence. These parameters in general are not very common to include in a \gls{mcrt} simulation, unless modelling of these phenomena is vital.
...
Fluorescence occurs when a photon is absorbed by a fluorescent molecule and re-released with a new wavelength. Fluorescence	is a reactively common phenomena, and is heavily utilised in biophotonics and medicine, in order to image, or monitor molecules in tissue. Again the optical property that models fluorescence is coefficient that gives the probability of absorption and remission of a photon by a certain molecule. Usually this is in the form of an absorption coefficient or extinction coefficient. An extinction coefficient is 
