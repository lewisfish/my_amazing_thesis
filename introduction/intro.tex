...
This entails having fine grained knowledge of the patient down to the genome level, to understand how various drugs or treatments will affect the patient.
...
This model is updated via information from their physical counterpart which allows the digital twin predict it's physical counterparts future behaviour.
1Companies like Phillips use this in their MRI machines to help schedule downtime, and predict which parts the engineer will need on site, both of which minimises the downtime of the machine which is import for the hospital/clinic~\cite{henkvanhouten2018}.
...
The use of simulations techniques like \gls*{mcrt} allow testing \textit{in-silico}, can negate the need to test on humans or animals.
...
The theoretical groundwork for the biomarker is outlaid, along with discussion of how \gls*{mcrt} can model fluorescence.
