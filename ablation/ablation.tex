...
\centering
\includegraphics[]{}
\caption{Figure show the speedup gained by parallelisation of the heat simulation using the `halo' swapping technique. Data taken from a Intel Xeon E3-1245 v5, 8 core @ 3.5GHz machine.}
\label{fig:parallel}
\end{figure}
