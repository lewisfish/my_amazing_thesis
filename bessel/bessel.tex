...
\begin{figure}[!hbtp]
    ...
    \caption{Illustration of $\varphi MC$'s ability to model spherical aberrations. Top) Image generated using same setup as in~\cref{fig:gausssetup}, but with $D=1.5~mm$ within $\varphi$MC. Image shows the elongated focus and characteristic interference pattern behind the focus. Bottom) Illustration of rays traced through a lens which suffers from spherical aberration.}
...
To give a slightly more fair comparison, the Bessel beam was given $15\times$ more power than the Gaussian beam, this allows a better comparisons between the Gaussian beams' core and the Bessel beam's core.
