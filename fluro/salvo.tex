...
Currently risk factors are used to try and determine if a patient has \gls*{cvd}.
...
Therefore is there is dsfuntion, then the autofluroecnet signal from NASH will be affected, thus it can be used as as biomarker for disease.
...
The refractive indices of each layer is broadly the same and does ot vary form layer to layer by a large amount.
