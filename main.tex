...
\graphicspath{{./images/}{./bessel/images/}{./fluro/images/}{./madrid/images/}{./ablation/images/}{./MCRT/images/},{./appendix/}}%path for images
\usepackage{pdfpages}
...
\bibliography{./ablation/ablation,./MCRT/mcrt,./bessel/bessel,./fluro/salvo}
