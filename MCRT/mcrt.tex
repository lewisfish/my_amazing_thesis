...
This chapter will provide an overview of the Monte Carlo radiative transfer method and compare it to other methods. Details of the \gls*{mcrt} code developed during this project and used as the basis of the results reported in subsequent chapters is also presented. Validation of this code and details of computational speed up are also presented.
...
This section describes the implementation of the \gls*{mcrt} code and a description of  parallelisation.
