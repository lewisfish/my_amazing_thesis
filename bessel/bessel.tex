...
As discussed in~\nameref{sec:diffusionapprox}, this method has many downside when it comes to modelling light propagation in biological tissue.
...
Some of the techniques used by these authors include: artificial beam steering~\cite{hokr2015modeling}, generating skew rays~\cite{arnaud1985representation}, complex ray tracing~\cite{harvey2015modeling}, decomposition~\cite{worku2018decomposition}, electric field Monte Carlo~\cite{cai2014electric}, and wavefront tracing~\cite{volpe2017huygens}. %***maybe move this to intro section??***
