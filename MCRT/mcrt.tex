...
\begin{equation}
s\cdot \nabla L(r,s)=-(\mu_a+\mu_s)L(r,s)+\mu_a\int_{4\pi}p(s,s')L(r,s')d\omega'
\end{equation}

Where L(r,s) is the irradiance of light at a point r in the direction s. $\mu_s$ and $\mu_a$ are the scattering and absorption coefficients, and p(s,s') is the phase function
