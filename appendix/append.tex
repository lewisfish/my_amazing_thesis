...
\end{align}
\begin{equation}
\therefore R=I-2(N\cdot I) N
\end{equation}


\begin{align}
T&=A+B\\
A&=\sin\left(\theta_2\right) M\\
B&=\cos\left(\theta_2\right)(-N)\\
C&=\cos\left(\theta_1\right)N\\
M&=\frac{I+C}{\sin\left(\theta_1\right)}
\end{align}
...
\begin{align}
\therefore T&=\frac{\eta_1}{\eta_2}\left(I+\cos\theta_1 N\right)-N\cos\theta_2\\
T&=\eta+\left(\eta c_1-c_2\right)N
\end{align}
