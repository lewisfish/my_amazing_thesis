...
The scattering agent used is intralipid $20~\%$ (Sigma-Aldrich), which is diluted as shown in~\cref{tab:intra,fig:ilscatprop}.
...
\Cref{fig:helix} shows an element hat will introduce a helical phase shift to an incoming beam.

a~\cite{wei2015generation,qiong2012generalization,topuzoski2009conversion,kotlyar2006diffraction,khonina1992trochoson}%***cite these for higher order bessel beams + maybe LG beams
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.4\textwidth]{helicon.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\textwidth]{higher-order-bessel.pdf}
