...
\begin{figure}[!htpb]
    \centering
    \includegraphics[width=0.6\textwidth]{elastin-eem.pdf}
    \caption{Excitation-emission matrix for Elastin. Figure shows that the fluorescent signal from Elastin is strongest in the papillary dermis.}
    \label{fig:elastineem}
\end{figure}

\begin{figure}[!htpb]
    \centering
    \includegraphics[width=0.6\textwidth]{collagen-eem.pdf}
    \caption{Excitation-emission matrix for collagen. Figure shows that the fluorescent signal from collagen is strongest in the papillary dermis.}
    \label{fig:collageneem}
\end{figure}
