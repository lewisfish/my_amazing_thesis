...
\Cref{fig:flurosshow} shows the emission and absorption spectrum for these fluorophores.
...
S. Smirni \textit{et at.} took autofluorescence spectra from volunteers as they underwent a \gls*{porh} test.
\Gls*{porh} test is used to investigate and asses microvacular function.
It acheives this by usually inflating a cuff on an arm of a patient for a period of time and then letting it deflate.
...
\begin{figure}[!htpb]
  ...
  \caption{Example of PORH test whilst measuring autofluorescence and perfusion.}
  \label{fig:figure1}
\end{figure}
...
\begin{figure}[!htpb]
    \centering
    \includegraphics[width=0.7\textwidth]{NADH-eem.pdf}
...
\begin{figure}[!htpb]
    \centering
    \includegraphics[width=0.7\textwidth]{FAD-eem.pdf}
