...
For example, NADH is a intracellular co-enzyme that is a biomarker for metabolic activity and mitochondrial anomalies. 
...
FAD is also heavily involved in various metabolic activities and is part of a redox pair in respiration.
...
nadh oxiative stress indicative of cvds eh...
%explain how nadh for cvds and not anything else

Despite their appeal, using these novel biomarkers to diagnose and asses disease risks, information on the location of fluorescence, which fluorophores contribute to the signal and how much, how much the optics of tissue affect the signal, and the variability of the signal over different location on the body.
...
Overall the epidermis provides protection from mechanical stress, flexibility to the skin, UV protection, retains water, and stops foreign bodies or chemicals from entering the skin.
...
***talk about where fluros are in skin***
...
To this end the 3D skin model is shrunk to a 1D model in the z direction so that the optical integration routine can efficiently move the photon through the simulated medium.
