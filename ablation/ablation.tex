...
The pulse profile of the laser is the temporal profile of the laser pulse.
Lasers have either tophat, triangular or Gaussian profiles, though in reality the pulse is usually something in between these profiles.
The Pixel CO$_2$ laser states that the pulse profile is that of triangular pulse. 
All results presented thus far have been with a triangular pulse.

This section will investigate the difference in the ablation and thermal damage between the different laser pulse profiles.
...
\subsubsection{Investigating voxel temperate after ablation}
...
\begin{figure}[!ht]
	...
	\caption{Comparison of different voxel temperatures after ablation. Half refers to setting the temperature of a voxel to hlaf that of the ablation temperature. Room refers to room temperature, and ablation leaves the temperature at the ablation temperature.}
