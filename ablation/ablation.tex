...
This chapter uses \gls{mcrt} techniques coupled to a heat transfer simulation, to study the thermal damage to tissue due to fractional lasers. Fractionated ablative lasers  are ablative lasers where the power is spread over several beams, to leave viable tissue around zones of damaged/necrotic tissue~\cite{manstein2004fractional}. We present experimental work carried out on porcine tissue by our collaborators at the University of Dundee and the photobiology department at Ninewells hospital, along side our computational model of tissue ablation.
...
\vspace{-10pt}
	\centering
	\includegraphics[width=.95\textwidth]{validation.pdf}
...
\begin{figure}[!h]
	\centering
    \includegraphics[width=.95\textwidth]{slice.pdf}
...
\begin{figure}
	\centering
    \includegraphics[width=.95\textwidth]{70w-circular.pdf}
...
\end{figure}
 ...
 \begin{figure}
	\centering
    \includegraphics[width=.95\textwidth]{70w-gaussian.pdf}
...
\begin{figure}[!h]
	\centering
	\includegraphics[width=.95\textwidth]{damage-slice.pdf}
