...
\Cref{eqn:FDMheat4} gives the full numerical solution to the non-linear heat equation with a laser heat source. This will allow us to calculate the heat diffusion in the porcine tissue due to laser heating.
