...
As mentioned, Bessel beams and Gaussian beams are not alike, so to ensure a fairer comparison the Bessel beams central core width is set to that of the Gaussian beam's waist.
